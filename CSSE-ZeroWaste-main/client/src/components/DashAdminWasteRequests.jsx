    ...
    try {
      ...
      if (data.error) {
        ...
        const uniqueDistricts = [
          ...new Set(
            data.wasteRequests.map((wasteRequest) => wasteRequest.district)
          ),
        ];
        const uniqueCities = [
          ...new Set(
          ...
          <Table.Cell>
            <div className="flex justify-center items-center space-x-4">
              ...
              <Button
                ...
                outline
                className="flex items-center"
                onClick={() => handleAssignDriverClick(request)}
                disabled={
                  request.truckDriverStatus === "ACCEPTED" ||
                  request.requestStatus === "REJECTED" ||
                  request.requestStatus === "PENDING"
              ...
              >
                <FaUserTie className="mr-2 w-6 h-6" />
                Assign Driver
              </Button>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onChange={(selectedOption) => {
                      setFormData({
                        ...formData,
                        requestStatus: selectedOption.value,
                      });
                    }}
                    placeholder={updateData?.requestStatus}
                  />
                </div>
                {/* Quantity */}
                <div>
